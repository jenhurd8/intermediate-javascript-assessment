...
function frodo(startingHungerValue, startingDangerValue) {
  var hun = startingHungerValue;
  var dan = startingDangerValue;

  return {
    dinnerOverFire() {
      hun = startingHungerValue - 25;
      dan = startingDangerValue + 40;
      return { hunger: hun, danger: dan };
    },
    hidingInBush() {
      hun = startingHungerValue + 35;
      dan = startingDangerValue - 20;
      return { hunger: hun, danger: dan };
    }
  };
}
